	...
	while (!s_finished) {
		...
		if (!mySensors.Stop) {
			...
			if (mySensors.drain) {
				myValves.V06 = true;
				myValves.V02 = true;
				cout << "Draining, V06 opened" << endl;
				mySensors.Restart = true;
				mySensors.LT01 = false;
				mySensors.LSL01 = false;
			}
			else {
				myValves.V06 = false;
				myValves.V02 = true;
